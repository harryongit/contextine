...
const heroConfigs = {
    about: {
        badge: "Our Mission",
        heading: <>Liberate Teams <br /> From Compliance Debt</>,
        description: "We help builders proactively manage risk and build trust with stakeholders, without slowing down their pace of innovation.",
        images: [
        ...
        stats: {
            ...
            sublabel: "Standard baseline",
            footer: "Risk-First Culture",
            color: "#6366f1"
        }
    },
    careers: {
        badge: "Join Us",
        heading: <>Scale the Future <br /> of GRC Automation</>,
        description: "We are looking for passionate individuals who want to redefine how companies manage security and compliance in a cloud-native world.",
        images: [
