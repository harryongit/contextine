    ...
    <section className="py-20 px-6 md:px-12 bg-[#020617] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10 w-full">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 w-full max-w-6xl relative">
                ...
                <div className="absolute inset-0 border-[0.5px] border-white/5 rounded-[4rem] pointer-events-none opacity-20"></div>
                ...
                {benefitsList.map((benefit, i) => (
                    ...
                    >
                       ...
                       <p className="text-white/40 text-base font-inter font-medium opacity-80 group-hover:opacity-100 transition-opacity max-w-[280px] leading-relaxed mb-6 flex-1">
                          {benefit.desc}
                       </p>
                       
                       <div className="mt-8 flex items-center gap-2.5 text-brand font-black text-[10px] uppercase tracking-widest group-hover:translate-x-1 transition-transform">
                          <ArrowUpRight className="h-4 w-4" /> Solution Insight
                       </div>
                    </motion.div>
                ))}
            </div>
            ...
            <motion.div 
               ...
               className="mt-20 h-px w-full max-w-3xl bg-linear-to-r from-transparent via-brand to-transparent"
            ></motion.div>
        </div>
    </section>
  )
