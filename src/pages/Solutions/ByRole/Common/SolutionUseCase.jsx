  ...
  return (
    <section className="py-20 px-6 md:px-12 bg-[#F8FAFC] relative overflow-hidden text-slate-900 border-y border-slate-100 selection:bg-brand/10">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10 w-full">
            ...
            >
                <div className="absolute inset-x-0 top-0 h-2 bg-gradient-to-r from-transparent via-brand to-transparent"></div>
                ...
                <div className="absolute top-8 right-12 opacity-[0.03] group-hover:opacity-[0.08] transition-opacity duration-1000">
